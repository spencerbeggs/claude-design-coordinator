...
- Claude Code added [native support for cross-session messageing](https://code.claude.com/docs/en/cross-session-messaging) between agents in v2.1.224 This project was a fun experiment. Thank you to everyone who tried it out and provided feedback. No further releases, fixes or security patches will be published here. [#119][#119]

### Dependencies

| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @spencerbeggs/claude-coordinator-core | dependency | updated | 0.1.1 | 0.2.0 |
| @spencerbeggs/claude-coordinator-server | dependency | updated | 0.1.4 | 0.2.0 |

### Thanks

Thanks to [@spencerbeggs](https://github.com/apps/spencerbeggs) for their contributions!

[#119]: https://github.com/spencerbeggs/claude-design-coordinator/pull/119
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @spencerbeggs/claude-coordinator-core | dependency | updated | 0.1.0 | 0.1.1 |
| @spencerbeggs/claude-coordinator-server | dependency | updated | 0.1.3 | 0.1.4 |
...
[#110]: https://github.com/spencerbeggs/claude-design-coordinator/pull/110
